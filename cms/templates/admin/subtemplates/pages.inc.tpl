        ...
        <table class="table table-striped table-hover">
            ...
            foreach ($pages as $page): ?>
                <tr>
                    ...
                    <td class="nowrap"><?php echo date($lang['time_format'], $page['time']);
                        if (isset($users[$page['author']])) {
                            ?> <span class="smallx">
                            (<?php echo $users[$page['author']]; ?>)</span><?php } ?></td>
                    <td class="nowrap"><?php echo date($lang['time_format'], $page['last_modified']);
            ...
            <?php if ($settings['count_views']): ?>
                <tr>
                    <td colspan="4"
                        style="text-align:right;"><?php echo str_replace('[time]', date($lang['time_format'], $settings['counter_last_resetted']), $lang['total_views']); ?></td>
