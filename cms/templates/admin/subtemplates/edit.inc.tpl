...
<?php else: ?>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <button class="btn btn-lg btn-success btn-top float-xs-right"><span
                    class="ion-android-upload"></span> <?php echo $lang['edit_page_submit']; ?></button>
        </div>
    </div>
    ...
    <ul id="myTab" class="nav nav-tabs" role="tablist">
        <li class="nav-item"><a class="nav-link active" href="#page-content" data-toggle="tab"><?php echo $lang['content_marking']; ?></a></li>
        <li class="nav-item"><a class="nav-link" href="#sidebars" data-toggle="tab" role="tab"><?php echo $lang['sidebars_marking']; ?></a></li>
        <li class="nav-item"><a class="nav-link" href="#properties" data-toggle="tab" role="tab"><?php echo $lang['properties_marking']; ?></a></li>
        <li class="nav-item"><a class="nav-link" href="#include" data-toggle="tab" role="tab"><?php echo $lang['include_marking']; ?></a></li>
        <li class="nav-item"><a class="nav-link" href="#notes" data-toggle="tab" role="tab"><?php echo $lang['page_notes_marking']; ?></a></li>
    </ul>
    ...
    <div class="tab-pane active" id="page-content">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-11">
                <div class="form-control">
                    <span class="input-control-addon"><?php echo BASE_URL; ?></span>
        ...
        <div class="form-group row">
            <label for="title"
                   class="col-lg-1 form-control-label control-label-left"><?php echo $lang['edit_title_marking']; ?></label>
        ...
        <div class="form-group row">
            <div class="col-lg-12">
                ...
                <?php if (isset($wysiwyg)): ?>
                    <a id="wysiwyg-toggle" class="btn btn-default btn-xs active float-xs-right"
                ...
                <?php else: ?>
                    <a id="wysiwyg-toggle" class="btn btn-default btn-xs float-xs-right"
                ...
                <textarea id="content" name="content" cols="100" rows="28"
                          class="form-control-label html"><?php if (isset($page_data['content'])) echo $page_data['content']; ?></textarea>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    ...
                    <a class="btn btn-default btn-xs" href="index.php?mode=modal&amp;action=insert_thumbnail"
                       ...
                       title="<?php echo $lang['insert_thumbnail_label']; ?>"><span
                            class="ion-ios-arrow-thin-up"></span></a>
                    <a class="btn btn-default btn-xs" href="index.php?mode=modal&amp;action=insert_gallery"
                       ...
                       title="<?php echo $lang['insert_gallery_label']; ?>"><span class="ion-images"></span></a>
                </div>
            </div>
        <?php endif; ?>
        ...
        <div class="form-group row">
            <div class="col-lg-12">
                ...
                <textarea id="sidebar_1" name="sidebar_1" cols="70" rows="13"
                          class="form-control-label html"><?php if (isset($page_data['sidebar_1'])) echo $page_data['sidebar_1']; ?></textarea>
            </div>
        </div>
        <!--<div class="checkbox">
...
<input id="sidebar_1_formatting" type="checkbox" name="sidebar_1_formatting" value="1"<?php if (isset($page_data['sidebar_1_formatting']) && $page_data['sidebar_1_formatting'] == 1): ?> checked="checked"'<?php endif; ?> /> <?php echo $lang['edit_formatting']; ?>
        ...
        <div class="form-group row">
            <div class="col-lg-12">
                ...
                <textarea id="sidebar_2" name="sidebar_2" cols="70" rows="13"
                          class="form-control-label html"><?php if (isset($page_data['sidebar_1'])) echo $page_data['sidebar_2']; ?></textarea>
            </div>
        </div>
        ...
        <div class="form-group row">
            <div class="col-lg-12">
                ...
                <textarea id="sidebar_3" name="sidebar_3" cols="70" rows="13"
                          class="form-control-label html"><?php if (isset($page_data['sidebar_1'])) echo $page_data['sidebar_3']; ?></textarea>
            </div>
        </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-10">
            <input id="page_title" type="text" name="page_title"
                   ...
                   class="form-control-label form-control-label-inline form-control-label-default"/>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-10">
            <select id="type" name="type" size="1" class="form-control-label form-control-label-inline form-control-label-default">
            ...
            <input type="text" name="type_addition"
                   ...
                   class="form-control-label form-control-label-inline form-control-label-medium"/>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-10">
            <select id="menu_1" name="menu_1" size="1" class="form-control-label form-control-label-inline form-control-label-medium">
            ...
            <select name="menu_2" size="1" class="form-control-label form-control-label-inline form-control-label-medium">
            ...
            <select name="menu_3" size="1" class="form-control-label form-control-label-inline form-control-label-medium">
        ...
        <div class="col-lg-10">
            <?php for ($i = 0; $i < $settings['breadcrumbs']; ++$i): ?>
                <select id="breadcrumbs_<?php echo $i; ?>" name="breadcrumbs[]" size="1"
                        class="form-control-label form-control-label-inline form-control-label-small">
                    <option
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-10">
            <input id="description" type="text" name="description"
                   ...
                   class="form-control-label form-control-label-large"/>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-10">
            <input id="page_info" type="text" name="page_info"
                   ...
                   class="form-control-label form-control-label-default"/>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-10">
            <select id="gcb_1" name="gcb_1" size="1" class="form-control-label form-control-label-inline form-control-label-medium">
                <option value="">#1</option>
                <?php if (isset($gcbs)): ?>
            ...
            <select name="gcb_2" size="1" class="form-control-label form-control-label-inline form-control-label-medium">
                <option value="">#2</option>
                <?php if (isset($gcbs)): ?>
                    <?php foreach ($gcbs as $gcb): ?>
                        <option
            ...
            <select name="gcb_3" size="1" class="form-control-label form-control-label-inline form-control-label-medium">
                <option value="">#3</option>
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-10">
            <select id="template" name="template" size="1" class="form-control-label form-control-label-default">
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-10">
            <select id="language" name="language" size="1" class="form-control-label form-control-label-default">
                <option
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-10">
            <input type="text" id="tv" name="tv" value="<?php if (isset($page_data['tv'])) echo $page_data['tv']; ?>"
                   ...
                   class="form-control-label form-control-label-default" size="40"/>
        </div>
    </div>
    ...
    <div class="tab-pane fade" id="include">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-10">
                ...
                <select name="include_rss" size="1" class="form-control-label form-control-label-inline form-control-label-medium">
                    <option
                ...
                <select name="include_sitemap" size="1" class="form-control-label form-control-label-inline form-control-label-medium">
                    <option
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-9">
                <input type="text" id="include_order" name="include_order"
                       ...
                       class="form-control-label form-control-label-small">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-9">
                <input type="text" id="teaser_headline" name="teaser_headline"
                       ...
                       size="35" class="form-control-label">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-9">
                <textarea id="teaser" name="teaser" cols="75" rows="13"
                          class="form-control-label"><?php if (isset($page_data['teaser'])) echo $page_data['teaser']; ?></textarea>
            </div>
        </div>
...
<a class="btn btn-default modal-invoker" href="index.php?mode=modal&amp;action=insert_raw_image"
   ...
   data-insert="#teaser_img"><span class="glyphicon glyphicon-search"></span></a>
        ...
        <div class="form-group row">
            <div class="col-lg-12">
                ...
                <textarea id="page_notes" name="page_notes" cols="70" rows="20"
                          class="form-control-label"><?php if (isset($page_data['page_notes'])) echo $page_data['page_notes']; ?></textarea>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <button class="btn btn-lg btn-success float-xs-right"><span
