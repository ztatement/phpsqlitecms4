 ...
 <div id="comments" class="card">
  ...
  <div class="card-header">
   ...
   <a class="btn btn-danger btn-sm float-xs-right font-white" href="<?php echo BASE_URL . PAGE; ?>,openclose">
    <span class="ion-locked font-white"></span> <?php echo $lang['comments_close']; ?>
   </a>
   <?php else: ?>
   <a class="btn btn-success btn-sm float-xs-right" href="<?php echo BASE_URL . PAGE; ?>,openclose">
    <span class="ion-unlocked font-white"></span> <?php echo $lang['comments_open']; ?>
   </a>
   <?php endif; ?>
   <?php endif; ?>
   <h3 class=""><?php echo $lang['comment_headline']; ?><span class="tag-pill"><?php echo $total_comments; ?></span></h3>
  </div>
  ...
  <div class="card-block">
   ...
   <form id="commentform" method="post" action="<?php echo $BASE_URL . PAGE; ?>#comments">
    <div>
     ...
     <p>
      <label for="comment_text"><strong><?php echo $lang['comment_edit_text']; ?></strong></label><br>
      <textarea id="comment_text" class="form-control" 
                name="comment_text" 
                cols="63"
                rows="10"><?php echo $edit_data['comment']; ?>
      </textarea>
     </p>

     <p class="userdata">
      <label for="name"><?php echo $lang['comment_input_name']; ?></label><br>
      <input type="text" id="name" class="form-control" 
             name="name"
             value="<?php echo $edit_data['name']; ?>" size="30"/>
     </p>

     <p class="userdata">
      <label for="email_hp"><?php echo $lang['comment_input_email_hp']; ?></label><br>
      <input type="text" id="email_hp" class="form-control" 
             name="email_hp"
             value="<?php echo $edit_data['email_hp']; ?>" size="30"/>
     </p>

     <p>
      <input class="btn btn-primary" name="edit_save" 
             type="submit"
             value="<?php echo $lang['comment_input_submit']; ?>"/>
     </p>
    </div>
   </form>
  ...
  <span class="ion-trash-a font-white"></span></a>
  </div>
  <?php endif; ?>
  </div>
  <?php endforeach ?>
  ...
  <h3><span class="ion-alert-circled"></span> <?php echo $lang['error_headline']; ?>
  </h3>
  <ul>
  ...
  <span class="ion-plus"></span> <?php echo $lang['comments_add_comment']; ?>
  </button>
  </p>
  <?php endif; ?>
  ...
  <p><em><span class="ion-lock-combination"></span> <?php echo $lang['comments_closed']; ?></em></p>
  <?php endif; ?>
