<?php if (isset($edit_news)): ?>
    ...
    <?php if (isset($errors)): ?>
        <div class="alert alert-danger">
            ...
            <h3><span class="ion-alert-circled"></span>
    ...
    <form action="<?php echo BASE_URL . PAGE; ?>" method="post">
        <div class="form-group row">
            <input class="form-control" type="hidden" name="mode" value="news"/>
            <input class="form-control" type="hidden" name="edit_news_submit" value="true"/>
...
elseif (isset($news_item)): ?>
    ...
    <?php if ($authorized_to_edit): ?>
        <p>
            <a class="btn btn-primary btn-sm" href="<?php echo BASE_URL . PAGE; ?>,<?php echo $news_item['id']; ?>,edit"
               title="<?php echo $lang['edit']; ?>"><span class="ion-edit"></span></a>
...
elseif (isset($news)): ?>
    ...
    <?php if ($authorized_to_edit): ?>
        <p><a class="btn btn-success" href="<?php echo BASE_URL . PAGE; ?>,add_item"><span
                    class="ion-plus"></span> <?php echo $lang['simple_news_add_item']; ?></a></p>
    <?php endif; ?>
        ...
        <ul class="pagination">
            <?php if ($pagination['previous']): ?>
                ...
                if ($pagination['previous'] > 1): ?>,,<?php echo $pagination['previous']; endif; ?>">
                    <span  class="ion-chevron-left"></span></a></li><?php endif; ?>
            ...
            <?php if ($pagination['next']): ?>
                <li><a href="<?php echo BASE_URL . PAGE; ?>,,<?php echo $pagination['next']; ?>">
                    <span class="ion-chevron-right"></span></a></li><?php endif; ?>
        </ul>
    <?php endif; ?>
...
<?php
    ...
    <?php if ($authorized_to_edit): ?>
        <p><a class="btn btn-success" href="<?php echo BASE_URL . PAGE; ?>,add_item">
                <span class="ion-plus"></span> <?php echo $lang['simple_news_add_item']; ?></a></p>
    <?php endif; ?>
